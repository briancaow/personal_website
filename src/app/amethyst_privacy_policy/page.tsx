export default function AmethystPrivacyPolicy() {
  return (
    <main className="p-10 min-h-screen">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Amethyst, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Amethyst.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>By email: briancao.dev@gmail.com</li>
      </ul>
    </main>
  );
}
